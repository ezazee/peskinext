// src/shared/components/ui/shipping/ShippingModalMobile.tsx
"use client";
...
export default function ShippingModalMobile({ open, data, onClose }: Props) {
  // Lock body scroll → hindari double scroll
  useEffect(() => {
    if (!open) return;
  ...
  // Fokuskan sheet saat open (aksesibilitas)
  ...
  return (
    <>
      ...
      <div
        onClick={onClose}
        className={`fixed inset-0 z-[89] bg-black/30 transition-opacity duration-200 ${
      ...
      <div
        ...
        className={[
          ...
          "flex max-h-[85vh] flex-col pointer-events-auto",
        ].join(" ")}
      ...
      >
        ...
        {/* BODY – hanya area ini yang bisa di-scroll */}
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 pb-4">
          {data.groups.map((g) => (
            <section key={g.label} className="mb-4">
              ...
              {/* Kartu list rapi: ring tipis + divide */}
