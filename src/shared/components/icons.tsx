...
export const BellIcon = () => (
  <button className="p-2 rounded-full hover:bg-tertiary">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-6 w-6 text-secondary"
      fill="none"
...
export const FeedIcon = ({ active = false }: { active?: boolean }) => (
  <svg
    className={`h-6 w-6 ${active ? "text-primary" : "text-secondary"}`}
    fill="none"
    viewBox="0 0 24 24"
...
export const TransactionIcon = ({ active = false }: { active?: boolean }) => (
  <svg
    className={`h-6 w-6 ${active ? "text-primary" : "text-secondary"}`}
    fill="none"
    viewBox="0 0 24 24"
...
export const AccountIcon = ({ active = false }: { active?: boolean }) => (
  <svg
    className={`h-6 w-6 ${active ? "text-primary" : "text-secondary"}`}
    fill="none"
    viewBox="0 0 24 24"
...
export const QrCodeIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M14.25 15.75h4.5a.75.75 0 00.75-.75v-4.5a.75.75 0 00-.75-.75h-4.5a.75.75 0 00-.75.75v4.5a.75.75 0 00.75.75z"
    />
  </svg>
);
...
export const GoogleIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 48 48">
    ...
    <path
      fill="#1976D2"
      d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C42.022,35.39,44,30.134,44,24C44,22.659,43.862,21.35,43.611,20.083z"
    ></path>
  </svg>
);
...
export const CouponIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12v.75m0 3v.75m0 3v.75m0 3V18m-3 .75h18A2.25 2.25 0 0021 16.5V7.5A2.25 2.25 0 0018.75 5.25H5.25A2.25 2.25 0 003 7.5v9A2.25 2.25 0 005.25 18.75h1.5M16.5 18.75h.008v.008h-.008v-.008z"
    />
  </svg>
);
