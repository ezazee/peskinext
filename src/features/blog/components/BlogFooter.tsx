            ...
            <div className="max-w-screen-xl mx-auto px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-primary font-bold text-xl mb-4">peskinpro blog</h3>
                        <p className="text-gray-500 text-sm leading-relaxed max-w-md">
                            Inspirasi harian untuk perjalanan kulit sehatmu. Temukan tips, review produk, dan panduan lengkap seputar skincare alami.
                        </p>
                    </div>
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
                    <p>&copy; {new Date().getFullYear()} PE Skinpro. All rights reserved.</p>
